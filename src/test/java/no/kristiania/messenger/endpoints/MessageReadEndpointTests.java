...
public class MessageReadEndpointTests extends ServerTest {
    ...
    @Test
    void shouldGetUserViewsWhichHasReadMessage() throws Exception {
        ...
        var connection = getServerConnection(
                String.format("/api/message-read/%d", messageId));
        ...
        assertThat(connection.getResponseCode())
                ...
                .isEqualTo(200);
        assertThat(responseJson).contains("userId", "username", "dateRead");
        assertThat(responseJson).contains(Integer.toString(user2Id));
    }
}
